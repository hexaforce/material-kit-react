              ...
              >
                {emailSent ? (
                  ...
                  <div>
                    ...
                    {tab === 'email' && (
                      <div>
                        <TextField error={Boolean(formik.touched.email && formik.errors.email)} fullWidth helperText={formik.touched.email && formik.errors.email} label='Email Address' name='email' onBlur={formik.handleBlur} onChange={formik.handleChange} type='email' value={formik.values.email} variant='outlined' />
                        <FormHelperText sx={{ mt: 1 }}>Enter a valid email since this is a fully integrated authentication system. Optionally you can skip.</FormHelperText>
                        {formik.errors.submit && (
                          <Typography color='error' sx={{ mt: 2 }} variant='body2'>
                            {formik.errors.submit}
                          </Typography>
                        )}
                        <Button fullWidth size='large' sx={{ mt: 3 }} onClick={() => formik.handleSubmit()} variant='contained'>
                          Continue
                        </Button>
                    ...
                    {tab === 'phoneNumber' && (
                      <div>
                        ...
                        <Typography color='text.secondary'>Zalter Identity does support SMS passcodes, but to prevent unnecessary costs we disabled this feature in the demo.</Typography>
                      </div>
                    )}
                  </div>
                )}
